    ...
    <div className="flex mx-auto h-full w-full">
      <div className="flex flex-1/2 flex-col my-3 justify-center items-center h-full">
        ...
        <form onSubmit={handleSubmit} className="p-8 rounded-lg w-96">
          ...
          <NavLink
            to="/forget-password"
            className="dark:text-gray-100 text-md hover:underline mb-2 block"
          >
            Forgot password?
          </NavLink>
          <button
      ...
      <div className="flex flex-1/2 justify-center items-center text-white bg-neutral-600 dark:bg-neutral-800 rounded-l-4xl">
        <div className="flex flex-1/2 flex-col gap-16 justify-center items-center h-full">
          ...
          <div className="flex justify-center gap-4 items-center flex-col">
            ...
            <NavLink
              to="/register"
              className="text-center ring-1 ring-neutral-300 hover:ring-0 w-full bg-gradient-btn text-white p-2 rounded-lg cursor-pointer text-lg font-bold hover-scale-right-top-bottom"
            >
              Sign Up
            </NavLink>
          </div>
