...
const UserSidebar: React.FC = () => {
  ...
  return (
    <div className="w-full h-screen py-2 bg-gradient-to-tl from-amber-950 to-gray-950 text-white flex flex-col justify-between shadow-[0px_5px_6px] shadow-amber-500/80 rounded-r-lg">
      {/* Logo */}
      <NavLink to="/" className="text-center mx-auto size-12 my-3">
        <img src="/logo.png" alt="BookBary" />
      </NavLink>
      ...
      <button
        className="relative group my-3 w-full flex-center mt-auto"
        onClick={handleLogout}
      >
        <NavLink
          to="/login"
          className="flex-center p-2 rounded-lg hover:text-amber-500"
        >
          <LogOutIcon />
        </NavLink>
        {/* Tooltip */}
